...
const FinancialCompaniesSection = () => {
    return(
        ...
        <section className="flex flex-col w-auto h-auto py-20 justify-center items-center px-20 py-20 text-primary-primary bg-secondary-light mobile-sm:px-8">
            ...
            <div className="desktop:flex-row flex justify-center max-w-screen-lg w-auto mobile-sm:flex-col items-center h-auto ">
                ...
                <div className="w-1/2 px-10 py-8 flex flex-col  justify-center items-center mobile-sm:w-auto mobile-sm:px-2">
                 
                    <p className="text-lg text-normal pb-6 mobile-sm:px-0 ">Trabajamos con diversas entidades Financieras y Bancarias de Panamá, No solicitamos ningún tipo de pago o póliza. Nuestros servicios son 100% GRATIS.</p>
