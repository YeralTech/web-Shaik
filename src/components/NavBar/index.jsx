 ...
 const navLinkClassesMobile = 'text-primary-background w-auto hover:bg-primary-primary w-full hover:text-primary-light px-10 py-2 w-auto rounded relative focus:bg-secondary-primary focus:text-primary-primary'
  ...
  return (
    <nav id='navbar' className="flex flex-col items-center py-6 w-auto px-4 shadow-lg mb-2 mobile-sm:px-2 mobile-lg:px-4 ">
      <div id='navbar-container' className="navBar-container flex justify-center items-center p-2 max-w-screen-xl w-full text-primary-primary  mobile-sm:justify-between p-0 w-auto px-2 mobile-lg:justify-justify-between px-20">
        <img id='navbar-logo' className="desktop:w-72 h-auto mr-20 mobile-sm:mr-8 w-60 mobile-lg:mr-12 tablet:mr-20" src={logoShaik} alt="Logo de Shaik Asesores" />
      ...
      {openMenuMobile && (
        <div id='menu-mobile ' className="bg-primary-white absolute flex flex-col w-auto h-70  rounded-lg py-6  top-24 left-1/2 shadow-lg z-50 desktop:hidden tablet:left-3/4  mobile-sm:left-10  mobile-lg:left-1/2">
          <ul id='navbar-list-mobile' role="list" className=" active flex flex-col gap-4 items-center text-center text-base">
